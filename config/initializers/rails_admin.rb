# RailsAdmin config file. Generated on July 27, 2013 19:07
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Shoutapp', 'Admin']
  ...
  # config.excluded_models = ['Badge', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Badge', 'User']
  ...
  #     configure :shouts, :has_many_association         # Hidden 
